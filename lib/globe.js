...
export function init() {
    ...
    function fetchCountries(originCountry) {
        ...
        if (passData[originCountry]) {
            return ($('#destinations').text(passData[originCountry].toString()));
        }
    }
    ...
    function onMouseClick(event) {
        ...
        raycaster.setFromCamera(mouse, camera); {
            ...
            if (intersects.length > 0) {
                ...
                const clickedCountry = clickedObj.parent.userData["userText"];
                fetchCountries(clickedCountry);
